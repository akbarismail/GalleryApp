...
const Photos = () => {
  ...
  //     await loadDataPhotos();
  //     await loadDataPhotoByQuery(sort, submited);
  //   } catch (error) {
  //     setError(error);
  //   }
  // };

  const loadDataPhotoByQuery = async (sort, submited) => {
    try {
      setLoading(true);
  ...
  useEffect(() => {
    // TODO: answer here
    loadDataPhotoByQuery(sort, submited);
  }, [sort, submited]);
